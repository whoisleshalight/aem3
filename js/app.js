(() => {
    ...
    function initSliders() {
        if (document.querySelector(".expertise-mobile-swiper")) new Swiper(".expertise-mobile-swiper", {
            ...
            speed: 800,
            pagination: {
                el: ".expertise-mobile-swiper-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".expertise-mobile-swiper-button-prev",
                nextEl: ".expertise-mobile-swiper-button-next"
            },
            on: {}
        });
        if (document.querySelector(".main-mobile-swiper")) new Swiper(".main-mobile-swiper", {
            ...
            speed: 800,
            pagination: {
                el: ".main-mobile-swiper-pagination",
                clickable: true
            },
            autoplay: {
                delay: 8e3,
    ...
    document.addEventListener("DOMContentLoaded", (function(e) {
        const tippyElements = document.querySelectorAll(".tippy-element");
        if (tippyElements) tippyElements.forEach((element => {
            const eBtn = element.querySelector(".button");
